...
def setup_webserver(webServer:brWebServer, webui:brWebUIModule):
    ...
    webServer.buildRoute(brWebServer.route.GET_ROUTE, "/insecureannounce", webui.insecureAnnounce)
    webServer.buildRoute(brWebServer.route.POST_ROUTE, "/insecureannounce", webui.insecureAnnouncePost)
